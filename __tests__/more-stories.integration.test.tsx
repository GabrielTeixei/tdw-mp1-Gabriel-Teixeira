...
const mockPosts: Post[] = [
  ...
  },
  {
    ...
    author: { name: 'Ana', picture: { url: 'https://example.com/avatar2.jpg' } },
    slug: 'segundo-post',
  },
];
...
describe('MoreStories Integration', () => {
  it('renders all posts with author, cover image and date', () => {
    ...
    const coverImage1 = screen.getByAltText('Cover Image for Post Teste') as HTMLImageElement;
    const coverImage2 = screen.getByAltText('Cover Image for Segundo Post') as HTMLImageElement;
  ...
  it('links para as páginas corretas dos posts', () => {
    ...
    expect(document.querySelector<HTMLAnchorElement>('a[href="/posts/post-teste"]')).toBeInTheDocument();
    expect(document.querySelector<HTMLAnchorElement>('a[href="/posts/segundo-post"]')).toBeInTheDocument();
  });
});
